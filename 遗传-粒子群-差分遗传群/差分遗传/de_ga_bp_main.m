...
for i=1:maxgen
    ...
    % 变异
    individuals.chrom=DE_Mutation1(pmutation,lenchrom,individuals.chrom,sizepop,i,maxgen,bound);
...
de_ga_test1=reverse_data(test_simu);
...
%保存结果
tracedega=trace;
save DE_GA de_ga_test1 T_test tracedega